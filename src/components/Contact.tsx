      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">hello@jddevelopment.com</p>
                  </div>
                </div>
          ...
          <div className="fade-in-up" style={{ animationDelay: '0.2s' }}>
            <form className="glass rounded-2xl p-8 border border-primary/10 hover-lift space-y-6">
              ...
              <div>
                ...
                <Input type="email" placeholder="john@example.com" className="border-primary/20 focus:border-primary" />
              </div>

              <div>
                <label className="block text-sm font-medium mb-2">Project Type</label>
                <select className="w-full px-3 py-2 border border-primary/20 rounded-lg focus:border-primary focus:outline-none bg-background">
